			...
			<div className="">
				<div className="flex flex-1 flex-col gap-2 py-4">
					...
					<div className="flex items-center justify-between gap-3">
						...
						<div className="inline-flex items-center gap-2 text-[13px] text-cyan-600  rounded px-2 py-1">
							{storyInfo &&
								storyInfo.visitedLocation.map(
									(item, index) =>
										storyInfo.visitedLocation.length >= index + 1 && (
											<div
												className="flex items-center gap-2 text-[13px] text-cyan-600 bg-cyan-200/40 rounded px-2 py-1"
												key={index}
											>
